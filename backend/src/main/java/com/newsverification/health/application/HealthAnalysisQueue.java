...
/** Redis Streams 교체 가능한 유한 Queue 경계 */
public interface HealthAnalysisQueue {

    /** Queue 수용 시 작업 추가 */
    boolean enqueue(HealthAnalysisTask task);

    /** 자동 재전달 없는 단일 작업 소비 */
    Optional<HealthAnalysisTask> take();

    /** 전역 단일 Worker Lease 획득 */
