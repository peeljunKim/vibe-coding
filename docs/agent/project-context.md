...
| Cache/Session | Redis 8.8 Compose, Spring Data Redis와 Redis Session 구현; 3일 분석 Cache는 환경 변수만 있고 기능은 미구현 |
...
언론사 지원 범위는 의료 전문 여부가 아니라 국내 이용 가능성과 안전한 공개 기사 접근·추출 품질을 기준으로 한다. 일반 언론사와 의료 전문 언론사를 함께 검증하고, 개별 기사의 건강·의학·보건 관련성은 건강 분석 기능에서 별도로 판별한다.
